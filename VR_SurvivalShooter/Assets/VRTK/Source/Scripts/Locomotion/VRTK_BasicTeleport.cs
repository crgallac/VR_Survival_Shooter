...
namespace VRTK
{
    ...
    public class VRTK_BasicTeleport : MonoBehaviour
    {
        ...
        public float timeBetweenTeleports = 3.0f;
        ...
        {
            if (enableTeleport && ValidLocation(e.target, e.destinationPosition) && e.enableTeleport  && (timer - timer_old)  >= timeBetweenTeleports)
            {
